...
- (void)drawRect:(CGRect)rect {
    ...
    //1.画一个圆角矩形以及一个头尖角
    UIBezierPath *berierPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(margin, margin, self.bounds.size.width-2*margin, self.bounds.size.height-2*margin) cornerRadius:10.0];
